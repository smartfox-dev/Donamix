...
// Cleanup the event listener when the component unmounts
  ...
  return (
    <Card className="flex flex-col w-full h-auto rounded-t-3xl rounded-b-none p-5 gap-2 justify-between">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-row items-center gap-2">
              ...
              {item.is_perspective == true && (
                            <img src='/images/home/perspective-sm.png' alt="" />
              )}
              {item.is_perspective == true && (
               <div className="font-poppins font-medium text-xs text-black">Perspective</div>
              )}
