        ...
        <div className='w-full flex flex-col gap-5'>
            <Collapsible title='Donamix Chat Rules and Regulations'>
                <div className='flex flex-row w-full gap-3 items-center'>
                    ...
                    <p className='font-sans font-normal text-base'>By entering Lebanon chat, you agree to be at least 13 years of age.</p>
                </div>
                <div className='flex flex-row w-full gap-3 items-center'>
                    <img src='/images/home/check.svg' className="lg:w-[20px] md:w-[30px] sm:w-[30px] w-[30px] lg:h-[20px] md:h-[30px] sm:h-[30px] h-[30px]" />
            ...
            <Collapsible title="Lebanon Chat Room Connect with Lebanese Worldwide">
                <p className='font-sans font-normal text-base leading-8'>We have designed this chat room for anyone with questions about Lebanon and anyone trying to find their Lebanese roots. Contact your relatives and find out about their health. Our Lebanese chat room will let you link directly with people worldwide who live and love Lebanon. Lebanon chat room is online chat portal that connect you to people all over the world who love Lebanon. Chatting with people from different cities and regions of Lebanon helps you make new connections, share ideas, passion and discuss personal interests. Lebanon chat room is a place where you can interact with people all over Lebanon and also around the globe.

Make new friends there and get acquainted with like-minded people. Thus, you can relate to people from different cities and countries. Talking and connecting with strangers online helps you meet people who are interested in the same things as you are from different cities and regions of Lebanon. These online chat rooms give you the opportunity to make new friends and help you in broadening your social network. Here you can quickly meet new Lebanese friends from Lebanon without registration.

The best thing about Lebanon chat room is that it is free, there is no registration fees. You can simply enter as a guest or with your own account.</p>
