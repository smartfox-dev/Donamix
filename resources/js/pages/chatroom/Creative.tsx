        ...
        <div className='w-full flex flex-col gap-5'>
            <Collapsible title='Donamix Chat Rules and Regulations'>
                <div className='flex flex-row w-full gap-3 items-center'>
                    ...
                    <p className='font-sans font-normal text-base'>By entering The Creative Corner chat, you agree to be at least 13 years of age.</p>
                </div>
                <div className='flex flex-row w-full gap-3 items-center'>
                    <img src='/images/home/check.svg' className="lg:w-[20px] md:w-[30px] sm:w-[30px] w-[30px] lg:h-[20px] md:h-[30px] sm:h-[30px] h-[30px]" />
            ...
            <Collapsible title={'The Creative Corner, Connect with Artists Worldwide'}>
                <p className='font-sans font-normal text-base leading-8'>Are you interested in talking to people who love art as much as you do? Join the Artist chat room now that will put you in touch with people from all over the world who love and want to chat about art and design. In Artist Chat Room, people discuss visual art and design. Join their discussions, and you can also make new like-minded friends from different countries and regions of the globe. In the world of modern art, graphic design and photography, many innovative and fun words grow out of the need for people to talk to.

The Artist Chat Room is an art discussion group that is solely designed for those people -- who want to discuss many different forms of art and design like creative expression and self-improvement. This discussion is for those who love art and design. Those who cherish art should use Artist Chat Room. You can join this for free, and you can share your art, view those shared by others, and talk about your art. You can find different friends from all over the world without registering.

The best thing about this chat room is that it is free, there is no registration fees. You can simply enter as a guest or with your own account.</p>
