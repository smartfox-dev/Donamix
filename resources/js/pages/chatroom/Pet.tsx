        ...
        <div className='w-full flex flex-col gap-5'>
            <Collapsible title='Donamix Chat Rules and Regulations'>
                <div className='flex flex-row w-full gap-3 items-center'>
                    ...
                    <p className='font-sans font-normal text-base'>By entering Pet Lovers' chat, you agree to be at least 13 years of age.</p>
                </div>
                <div className='flex flex-row w-full gap-3 items-center'>
                    <img src='/images/home/check.svg' className="lg:w-[20px] md:w-[30px] sm:w-[30px] w-[30px] lg:h-[20px] md:h-[30px] sm:h-[30px] h-[30px]" />
            ...
            <Collapsible title="The Pet Lovers' Oasis Chat Room Connect with Pet Lovers Worldwide">
                <p className='font-sans font-normal text-base leading-8'>Welcome to The Pet Lovers' Oasis, a haven for pet enthusiasts to connect, learn, and celebrate the wonderful world of our furry friends. Whether you're a proud pet owner or simply have a love for animals, this is the perfect place for you.

Connect with Fellow Pet Enthusiasts: Join our vibrant community of pet lovers from around the globe. Share your experiences, ask questions, and connect with like-minded individuals who understand the joy and challenges of pet ownership. This is your opportunity to build meaningful connections with fellow pet enthusiasts.

Gain Valuable Insights: Our team of pet experts is here to provide you with valuable insights and guidance on all aspects of pet care. From choosing the right pet for your lifestyle to health and nutrition tips, we cover a wide range of topics to help you become the best pet parent you can be.

Celebrate the Joy of Pet Ownership: At The Pet Lovers' Oasis, we believe that pets bring immense joy and love into our lives. Join us in celebrating the unconditional love, loyalty, and companionship that our furry friends provide. Share heartwarming stories, adorable pet pictures, and memorable moments that make pet ownership so special.

Discover Pet-Friendly Resources: Explore our curated list of pet-friendly resources, including pet-friendly travel destinations, products, and services. Whether you're looking for the best dog-friendly parks or recommendations for pet grooming, we've got you covered. Let us help you make the most of your pet-friendly lifestyle.

Stay Updated with the Latest Trends: From pet wellness trends to the latest pet gadgets and accessories, we'll keep you in the loop with the latest happenings in the pet world. Discover new products, training techniques, and innovations that will enhance your pet's well-being and happiness.

Join The Pet Lovers' Oasis today and become part of a community dedicated to all things pets. Connect with fellow pet enthusiasts, gain valuable insights, and celebrate the joy of pet ownership. Whether you have a dog, cat, bird, or any other furry friend, we welcome you to our oasis of love, knowledge, and appreciation for our beloved pets.</p>
