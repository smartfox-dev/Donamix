...
const Footer = () => {
  ...
  const gotoPrivacyPolicy = () => navigate('/policy');
          ...
          <div className="xl:flex-[4]">
            ...
            <div className="justify-between lg:gap-8 lg:flex">
              <ul className="lg:flex-[2] flex flex-col flex-wrap gap-2 pl-5 md:px-0 text-white list-disc h-[350px] text-[16px]">
                ...
                <li className="font-urbanist cursor-pointer" onClick={() => {navigate('/donation')}}>Support us</li>
                ...
                {/* <li className="font-urbanist cursor-pointer" onClick={gotoBlog}>Blog</li> */}
                {/* <li className="font-urbanist">Conversations</li> */}
                <li className="font-urbanist cursor-pointer" onClick={gotoPrivacyPolicy}>Privacy Policy</li>
