...
const Block: React.FC<IUserProfileProps> = ({ }) => {
    ...
    useEffect(() => {
        ...
        getIDProfile(parseInt(params.id))
            .then((res) => {
                if (res.code === CONSTANTS.SUCCESS) {
                    if (res.data) {
                        setProfile(res.data);
            ...
            <div className="flex flex-row">
                ...
                <div className="flex-1 xl:p-20 xl:pr-40 sm:p-10 p-4 w-0">
                    <div className="flex flex-col w-full gap-5">
                        <h3 className="text-2xl font-bold text-black font-poppins">Block User</h3>
                        ...
                        <div className="flex flex-col w-full rounded-t-3xl p-8 bg-white gap-5 shadow-2xl">
                            <h3 className=' font-inter font-bold text-2xl'>Block</h3>
                            <p className=' font-sans font-normal text-xl text-[#6D6D6D]'>Please briefly explain why are you Blocking this user?</p>
                            ...
                            <div className="flex flex-row gap-4 justify-end">
                                ...
                                <Button variant="default" className="p-6" onClick={handleBlock}>Block</Button>
                            </div>
